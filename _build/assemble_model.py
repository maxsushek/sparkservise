...
# Уникальный per-model абзац (типичные поломки конкретного поколения) — снижает риск
# дубль-контента, добавляет реальную ценность. Факты выверены (verify-workflow).
NOTES = {
    "iphone-11": "iPhone 11 (2019 год) — одна из самых частых моделей в нашем сервисе: к 2026 году аккумулятор у большинства устройств деградировал, ёмкость опускается ниже 80% и телефон выключается на холоде. Чаще всего меняем батарею и дисплей — у iPhone 11 ЖК-матрица (LCD), её замена заметно дешевле, чем OLED у Pro-версий. Также популярны замена основной камеры (запотевание стекла модуля) и чистка разъёма Lightning.",
    "iphone-12": "iPhone 12 (2020 год) — первый iPhone с плоскими гранями, MagSafe и защитой Ceramic Shield. Типичные неисправности к 2026 году: износ аккумулятора, трещины OLED-дисплея при ударах по углам, пропадание сотовой сети после падений. Восстанавливаем Face ID и меняем заднее стекло с сохранением магнитов MagSafe.",
    "iphone-13": "iPhone 13 (2021 год) получил увеличенный аккумулятор, но к 2026 многие устройства уже просят его замены. Частые случаи — замена разбитого OLED-дисплея, ремонт после попадания воды, замена основной и сверхширокоугольной камер. При ремонте сохраняем заводскую влагозащиту IP68.",
    "iphone-13-pro-max": "iPhone 13 Pro Max (2021 год) — флагман с дисплеем ProMotion 120 Гц и самой ёмкой батареей своего поколения. Чаще всего попадает к нам с разбитым дорогим OLED-дисплеем, просадкой автономности и неисправностями телеобъектива (3× оптический зум). Восстанавливаем ProMotion и систему из трёх камер.",
    "iphone-14": "iPhone 14 (2022 год) внешне близок к 13-му, но с улучшенным охлаждением и экстренным вызовом SOS. Типичный ремонт — замена аккумулятора, OLED-дисплея и основной камеры, восстановление после влаги. Аппаратные функции безопасности при ремонте не затрагиваем.",
    "iphone-14-pro": "iPhone 14 Pro (2022 год) — первый iPhone с «островом» Dynamic Island и постоянно включённым экраном Always-On. Частые поломки: разбитый дисплей ProMotion 120 Гц, ускоренный износ батареи из-за Always-On, выход из строя основной 48-Мп камеры. Меняем дисплей с сохранением Dynamic Island и True Tone.",
    "iphone-14-pro-max": "iPhone 14 Pro Max (2022 год) — крупнейший экран и батарея линейки 14. В ремонт идёт с трещинами большого OLED-дисплея, деградацией аккумулятора (Always-On ускоряет износ) и проблемами 48-Мп камеры и телеобъектива. Восстанавливаем ProMotion 120 Гц и Dynamic Island.",
    "iphone-15": "iPhone 15 (2023 год) — первый базовый iPhone с разъёмом USB-C и Dynamic Island. Типичные обращения: замена дисплея и аккумулятора, ремонт нового порта USB-C (заряд идёт через раз после попадания пыли или влаги), замена заднего стекла с цветным напылением.",
    "iphone-15-pro": "iPhone 15 Pro (2023 год) — титановый корпус, разъём USB-C и настраиваемая кнопка «Действие». В ремонт попадает с разбитым дисплеем ProMotion 120 Гц, износом аккумулятора и неисправным USB-C. Сохраняем 120 Гц, True Tone и Face ID.",
    "iphone-15-pro-max": "iPhone 15 Pro Max (2023 год) — единственный в линейке с перископической камерой 5× и титановым корпусом. Чаще всего меняем дорогой OLED-дисплей ProMotion, аккумулятор и ремонтируем телеобъектив 5× (сложный оптический узел), а также разъём USB-C и заднее стекло.",
    "iphone-16": "iPhone 16 (2024 год) получил кнопку «Действие» и сенсорную Camera Control. Частые случаи: замена OLED-дисплея, аккумулятора, ремонт разъёма USB-C и восстановление новой кнопки Camera Control. Меняем заднее стекло без замены всего корпуса.",
    "iphone-16-pro-max": "iPhone 16 Pro Max (2024 год) — флагман с крупнейшим экраном ProMotion 120 Гц и продвинутой системой камер. В ремонт идёт с разбитым OLED-дисплеем, износом батареи и неисправностями камер, включая 5× телефото. Восстанавливаем ProMotion, Dynamic Island и Camera Control.",
}
...
def render(m):
    ...
    others = [x for x in MODELS if x["slug"] != slug]
