...
def render(dev, m):
    ...
    cat = {r[0]: r for r in REPAIRS[dev]}        # key -> (key,label,time,icon,desc)
    order = [r[0] for r in REPAIRS[dev] if r[0] in m["prices"]]
    pr = m["prices"]
...
<meta name="description" content="Ремонт @@NAME@@ в Одессе: @@LEAD_DESC@@. Бесплатная диагностика, гарантия 12 мес, оригинальные запчасти.">
